...
@Component({
  ...
  templateUrl: './article-three.page.html',
  styleUrls: ['./article-three.page.scss'],
})
export class ArticleThreePage implements OnInit {
  ...
  article = {
    ...
    picture: {
      photo:  'https://images.unsplash.com/photo-1531554694128-c4c6665f59c2?ixlib=rb-1.2.1&auto=format&fit=crop&w=1080&q=80',
