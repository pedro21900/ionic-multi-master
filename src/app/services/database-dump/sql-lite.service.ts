...
export class SQLiteService {
    ...
    public async downloadDatabase(update = false) {
        const dbImport = await this.http.get<JsonSQLite>('https://www.smsgi.com.br/gsm_alpha/services/passaporteEquestre/consulta/estadosPassaporteEquestre').toPromise();
    ...
    async dbConection(database: string): Promise<SQLiteDBConnection> {
        // try {
